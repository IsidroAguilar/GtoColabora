...
*********************************************************************************************/
load_theme_textdomain( 'gpp_theme', get_template_directory().'/languages' );
$locale = get_locale();
...
if ( function_exists( 'add_image_size' ) ) { 
    ...
    add_image_size( 'post-thumb', 275, 275, true ); //(cropped)
...
function theme_scripts_styles() {
    ...
    //loaded in head
    wp_enqueue_style( 'gipsy-style', get_stylesheet_directory_uri() . '/css/style.css' );
    ...
    wp_enqueue_script( 'gipsy-main-js', get_stylesheet_directory_uri() . '/js/main.js', array('jquery'), '1.0', true );
}
